...
if (shell.exec('node FilePackager.js ../../Applications/BPMGenesis/PackageCenter/dist/index.js ../../DemoApp/apps/PackageCenter.app').code !== 0) {
    shell.echo('Build failed');
    shell.exit(1);
}
shell.echo('App file done.');

shell.cp('-Rf', '../../DemoApp/apps/PackageCenter.app', '../../pythonProjects/bpmgenesis/src/portal/static/applications/PackageCenter.app');
shell.echo('App file done.');
...
const result = appStoreInfo.apps.find(item => item.id === 'PackageCenter');
